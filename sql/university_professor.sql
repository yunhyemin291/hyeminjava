...
CREATE TABLE `professor` (
  ...
  `pr_age` int DEFAULT NULL,
  `pr_phone` varchar(20) DEFAULT NULL,
  `pr_room` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`pr_num`)
...
INSERT INTO `professor` VALUES (2020110001,'홍길동',40,'010-1234-5678','교수실 101호');
